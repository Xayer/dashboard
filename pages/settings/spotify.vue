<template>
	<div>
		...
		<a v-if="!integrationActive && !$route.query.code" :href="authUrl">Authenticate with Spotify</a>
...
import { authenticateToken, clientId, getTopTracks, integrationActiveStorageKey, redirectUri, storageKey } from '@/modules/apis/spotify';
